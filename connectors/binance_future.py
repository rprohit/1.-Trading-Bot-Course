...
class BinanceFuturesClient:
    def __init__(self,public_key,secret_key,testnet):
        ...
        #Its key would be the symbol and value would be dictionary with bid and ask price
        self.prices = dict()
        self.id = 1
        self.ws = None
    ...
    def generate_siganture(self,data):
    ...
    def get_bid_ask(self,symbol):
        ...
        if ob_data is not None :
            #If symbol is not previusly in prices
    ...
    def get_balances(self):
        ...
        data['signature'] = self.generate_siganture(data)
    ...
    def on_open(self,ws):
        logger.info("Binance Websocket connection is opened")
